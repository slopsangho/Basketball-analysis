...
plt.plot(Salary[6], c = 'Purple', ls = '--', marker = '^', ms = 7, label = Players[6])
plt.plot(Salary[7], c = 'Black', ls = '--', marker = '^', ms = 7, label = Players[7])
plt.plot(Salary[8], c = 'Red', ls = '--', marker = '^', ms = 7, label = Players[8])
plt.plot(Salary[9], c = 'Green', ls = '--', marker = '^', ms = 7, label = Players[9])
...
plt.plot(Games[5], c = 'Yellow', ls = '--', marker = '^', ms = 7, label = Players[5])
plt.plot(Games[6], c = 'Purple', ls = '--', marker = 's', ms = 7, label = Players[6])
plt.plot(Games[7], c = 'Black', ls = '--', marker = 'o', ms = 7, label = Players[7])
plt.plot(Games[8], c = 'Red', ls = '--', marker = 'D', ms = 7, label = Players[8])
plt.plot(Games[9], c = 'Green', ls = '--', marker = '^', ms = 7, label = Players[9])
...
def myplot(playerlist):
    for name in playerlist:
        ...
        def myplot(playerlist):
            Col = {"KobeBryant":'Black',"JoeJohnson":'Red',"LeBronJames":'Green',"CarmeloAnthony":'Blue',"DwightHoward":'Magenta',"ChrisBosh":'Yellow',"ChrisPaul":'Purple',"KevinDurant":'Black',"DerrickRose":'Red',"DwayneWade":'Green'}
            Mrk = {"KobeBryant":'s',"JoeJohnson":'o',"LeBronJames":'^',"CarmeloAnthony":'D',"DwightHoward":'s',"ChrisBosh":'^',"ChrisPaul":'s',"KevinDurant":'o',"DerrickRose":'D',"DwayneWade":'^'}
            for name in playerlist:
